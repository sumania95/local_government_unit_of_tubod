...
from model_hris.designation.views import (
    Plantilla_AJAXView,
...
from model_hris.service_records.views import (
...
from model_hris.performance_management.views import (
    ...
    Accomplishment_Remove_AJAXView,
    Accomplishment_IPCR_AJAXView,
    Accomplishment_OPCR_LIST_AJAXView,
    Accomplishment_Semester_AJAXView,
    Accomplishment_Semester_Activate_AJAXView,
...
from model_hris.dtr.views import (
    Dtr_Assign_AJAXView,
...
urlpatterns = [
    ...
    path('api/accomplishment/remove/<int:pk>', Accomplishment_Remove_AJAXView.as_view(), name = 'api_accomplishment_remove'),
    ...
    path('accomplishment/semester', Accomplishment_Semester.as_view(), name = 'accomplishment_semester'),
    path('api/accomplishment/semester', Accomplishment_Semester_AJAXView.as_view(), name = 'api_accomplishment_semester'),
    path('api/accomplishment/semester/activate/<int:pk>', Accomplishment_Semester_Activate_AJAXView.as_view(), name = 'api_accomplishment_semester_activate'),
